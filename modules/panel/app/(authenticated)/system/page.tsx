    ...
    <SidebarInset>
      ...
      <div className="flex flex-1 flex-col">
        <div className="container mx-auto p-2 px-4">
          <h1 className="text-2xl font-bold mb-1">System Configs</h1>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="sq-AL">
                          Albanian (Albania)
                        </SelectItem>
                        <SelectItem value="am-ET">
                          Amharic (Ethiopia)
                        </SelectItem>
                    ...
                    {[
                      ...
                      >
                        ...
                        <Switch
                          id={key}
                          checked={
                            configs[key as keyof SystemConfigs] as boolean
                          }
