...
export function Languages() {
  return (
    <SelectContent>
      <SelectItem value="af-ZA">Afrikaans (South Africa)</SelectItem>
      ...
      <SelectItem value="ar-x-MAGHREBI">Arabic (Maghrebi)</SelectItem>
      <SelectItem value="hy-AM">Armenian</SelectItem>
      <SelectItem value="az-AZ">Azerbaijani (Azerbaijan) BETA</SelectItem>
      ...
      <SelectItem value="is-IS">Icelandic (Iceland) BETA</SelectItem>
      ...
      <SelectItem value="kk-KZ">Kazakh (Kazakhstan) BETA</SelectItem>
      ...
      <SelectItem value="lt-LT">Lithuanian (Lithuania) BETA</SelectItem>
      <SelectItem value="lv-LV">Latvian (Latvia)</SelectItem>
      <SelectItem value="mk-MK">Macedonian (North Macedonia)</SelectItem>
      ...
      <SelectItem value="nso-ZA">Northern Sotho (South Africa)</SelectItem>
      ...
      <SelectItem value="ss-latn-ZA">Swati (South Africa)</SelectItem>
      ...
      <SelectItem value="tn-latn-ZA">Tswana (South Africa)</SelectItem>
      <SelectItem value="tr-TR">Türkçe (Turkey)</SelectItem>
      <SelectItem value="uk-UA">Ukrainian (Ukraine) BETA</SelectItem>
