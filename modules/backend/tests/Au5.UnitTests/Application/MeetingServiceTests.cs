...
public class MeetingServiceTests
{
    ...
    public void AddParticipantToMeetShouldAddNewParticipantsOnly()
    {
        ...
        _service.AddParticipantToMeet([new Participant() { IsKnownUser = true, Id = userId, FullName = "u1" }, new Participant() { FullName = "u2" }], meetId);
        _service.AddParticipantToMeet([new Participant() { IsKnownUser = true, Id = userId, FullName = "u1" }, new Participant() { FullName = "u3" }, new Participant() { FullName = "u2" }], meetId);
